      ...
      <div className="container mx-auto">
        ...
        <div className="flex justify-between items-center border-t border-gray-100 mt-6 py-6 ">
          ...
          <nav className="flex gap-x-3">
            ...
            <a
              href="#"
              className="w-8 h-8 rounded-lg text-gray-500 transitions-colors hover:bg-primary-color hover:bg-opacity-10 flex items-center justify-center hover:text-primary-brand-color border rounded border-gray-100"
            >
              <BiGlobe size={21} />
            </a>
          </nav>
